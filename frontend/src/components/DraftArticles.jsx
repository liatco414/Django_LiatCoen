...
import { DeleteArticle, GetAllArticles } from "../services/articlesServices";
...
function DraftArticles() {
    ...
    useEffect(() => {
        GetAllArticles()
            .then((response) => {
                setDrafts(response.filter((article) => article.status === "draft"));
            })
    ...
    const handleDeleteArticle = (articleId) => {
        DeleteArticle(articleId)
            .then(() => {
                setDrafts((prevArticles) => prevArticles.filter((article) => article.id !== articleId));
            })
            .catch((error) => {
